...
distribution \citep{Andrich_1978, Bramley_2008}. Although this
substitution has a minimal impact on trait estimation or model
interpretation \citep{vanderLinden_et_al_2017_I, McElreath_2021},
Thurstone acknowledged that assuming equal discriminal dispersions and
zero correlation among stimuli' discriminal processes could introduce
significant problems. In particular, he recognized that while these
assumptions simplify the trait measurement model, they may not capture
the complexity of some traits or account for heterogeneous stimuli, such
as handwritten texts or English compositions
\citep{Thurstone_1927a, Andrich_1978, Bramley_2008, Kelly_et_al_2022}.
As a result, they can lead to unreliable and inaccurate trait estimates
...
on point estimates of the traits--typically the BTL scores or its
...
formulating a conceptual model represented by a Structural Causal Model
(SCM) and a Directed Acyclic Graph (DAG). This model integrates
Thurstone's core theoretical principles--such as the discriminal
processes of stimuli--alongside key CJ experimental design features,
including judges' bias, sampling procedures, and comparison mechanisms,
thereby disentangling the causal processes in the CJ system.
