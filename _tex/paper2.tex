...
Five research avenues, both current and new, deserve particular
attention. The following sections outline these avenues and explain how
our model provides a rigorous research framework to investigate them.
Notably, although it may seem like a natural next step to address these
questions through formal derivations, following the tradition of
classical statistical models like linear regression, we contend that the
complexity of the CJ system makes this approach impractical from the
outset. Instead, simulation-based methods, such as power analysis, offer
a more feasible and flexible alternative, enabling researchers to
investigate these questions without depending on cumbersome mathematical
proofs. Nonetheless, developing formal mathematical proofs remains an
essential goal for future work.
