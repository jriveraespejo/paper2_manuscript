...
\subsection{Future research}\label{sec-discussion_RA}

Five current and new research avenues deserve particular attention due
to their direct impact on the reliability and validity of trait
estimates and the accuracy of statistical inferences. The following
sections outline these avenues and explain how our model provides a
rigorous research framework to investigate them.
...
\subsubsection{The effects of hierarchies on experimental design and
inference}\label{sec-discussion_RA4}

{About the hierarchical structure of stimuli}

\subsubsection{The effects of non-dichotomous outcomes and
multidimensional traits on CJ experiments}\label{sec-discussion_RA5}
