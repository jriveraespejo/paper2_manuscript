...
Additionally, building on the arguments developed in
Section~\ref{sec-theory-issue1b}, the SCM incorporates a key design
features of CJ experiments: the judges' biases \((B_{kj})\). These
variables, along with the outcome \((O_{iahbjk})\), constitute the
