...
\urlstyle{same}
\hypersetup{
  pdftitle={Let's talk about Thurstone \& Co.: An information-theoretical analysis workflow for comparative judgments},
...
analysis workflow for comparative judgments}
...
biases \(B_{kj}\), which represent systematic deviations of an
individual judgment from the judge-specific expectations. Specifically,
the comparison outcome is assumed to be causally influenced only by the
discriminal difference, which itself is causally determined by the
discriminal processes and judgment-level biases. Notably, the SCM
...
\subsubsection{The outcome of analysis}\label{the-outcome-of-analysis}
