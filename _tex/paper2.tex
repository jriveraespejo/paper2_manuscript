...
measurement reliability and validity \citep{Perron_et_al_2015}, and
...
the BTL model assumptions to actively testing whether those assumptions
fit the data under analysis.
...
case, the comparison of these texts results in more judgment
discrepancies, yet the BTL model neither accounts for these cases nor
offers any means to address them, except their elimination from the
analysis.
...
Finally, as discussed in the previous section, researchers risk
discarding valuable information and introducing bias into trait
estimates when they remove \emph{misfit} judges--that is, judges whose
assessments deviate markedly from the shared consensus
\citep{Pollitt_2012a, Pollitt_2012b, vanDaal_et_al_2016, Goossens_et_al_2018},
considered outliers under the BTL model \citep{Grubbs_1969}. The
direction and magnitude of these biases remain unpredictable, as they
depend on which judges researchers exclude from the analysis
...
Notably, all these variables and the outcome \((O_{iahbjk})\) constitute
the preliminary set of endogenous variables,
