...
five cases derived from the general form, each progressively
...
scaling'' of traits and to ``allocate the compared stimuli on this
...
Causal and Bayesian inference methods. It begins by formulating a
conceptual model represented by an SCM and a DAG. This model integrates
Thurstone's core theoretical principles--such as the discriminal
processes (i.e., traits) of stimuli--alongside key CJ experimental
design features, including judges' bias, sampling procedures, and
comparison mechanisms. The study then translates the SCM into a bespoke
statistical model that addresses key limitations of the BTL model. In
particular, it enables the analysis of CJ data when the assumptions of
equal dispersion and zero correlation do not hold (see
Section~\ref{sec-theory-issue1a} and Section~\ref{sec-theory-issue1b}),
and when researchers seek to conduct statistical inference or hypothesis
testing (refer to Section~\ref{sec-theory-issue2}). These methodological
innovations potentially enhance the reliability and validity of trait
measurement \citep{Perron_et_al_2015} and improve the accuracy of
