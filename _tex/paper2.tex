...
each pair of sampled individuals from the population.
...
matrix (see equation (\ref{eq-mat12})), that is, this vector determines
\emph{which repeated comparisons the subset of judges makes for the
subset of stimuli produced by the subset of individuals} sampled from
the conceptual-population. This process ultimately generates the
...
However, because CJ experiments rarely use the exhaustive pairing of the
sampled judgments, judges, stimuli, and individuals --due to concerns
about the practical feasibility of the comparison task, like in
