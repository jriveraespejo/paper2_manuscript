...
Figure~\ref{fig-correlation}. Conversely, when the two texts have
similar or identical quality levels, higher correlations reduce the
likelihood that the discriminal difference distinctly favors one text
over the other, as the distribution narrows around zero (not depicted in
the figure).
