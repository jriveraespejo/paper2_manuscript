...
However, Case V (and its BTL model counterpart) was originally developed
to provide a ``rather coarse scaling'' of traits
...
As a result, its assumptions may not suit applications beyond the
psycho-physical contexts for which it was created. Thurstone himself
cautioned that its use ``should not be made without (an) experimental
test'' \citep[pp.~270]{Thurstone_1927b}, acknowledging that some
assumptions could prove problematic with more complex, less homogeneous
stimuli, such as handwriting or English compositions
\citep[pp.~374]{Thurstone_1927a}. Consequently, given that current CJ
applications often deal with complex, less homogeneous stimuli, two key
...
this assumption suggests that a judge's perception of quality in one
text does not influence their perception of the same trait in the
comparison text. Thurstone attributes this independence to the
cancellation of potential judges' biases, driven by opposing and equally
weighted factors; commonly known as `mood' and `simultaneous contrast'
effects, that operate during pairwise comparisons
\citep[pp.~268]{Thurstone_1927b}. This cancellation of bias has been
mathematically demonstrated by \citet{Andrich_1978}, assuming additive
biases and a logit scale derived from the BTL model.

However, given that evidence has shown judges' quality assessments are
influenced by multiple, complex aspects of the texts
\citep{vanDaal_et_al_2016, Lesterhuis_2018, Chambers_et_al_2022}, it is
plausible that the accuracy of these judgments also varies based on
factors such as age, culture, education, expertise
\citep[pp.~683]{Kelly_et_al_2022}, and ultimately, based on the
individual judge themselves
\citep{Gill_et_al_2013, vanDaal_et_al_2017, vanDaal_2020}.

{This means that the cancellation of judges' biases may not hold in
theory or practice, and that judges' biases may depend on the stimuli,
by means of an interaction (but present) or because the judges works as
a confounder}
