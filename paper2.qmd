...
SCMs and DAGs offer two key advantages for modeling causal structures. First, they enable researchers to represent causal relations in a non-parametric and fully interactive manner. This feature allows for feasible ACE identification strategies without specifying the data type or the nature of the functional dependence among variables [@Morgan_et_al_2014]. Second, regardless of complexity, they can represent a wide range of causal structures using only five fundamental building blocks [@Neal_2020; @McElreath_2020]. This feature allows researchers to decompose complex structures, facilitating their analysis by focusing on the causal assumptions associated with each building block [@McElreath_2020].
...
Plausible causal structure for the example.
:::
...
<!-- Ultimately, SCMs and DAGS help to formalize (causal) theoretical models into (probabilistic) statistical models for identification purposes [@McElreath_2020]. -->
