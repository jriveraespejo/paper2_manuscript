...
This section introduces a theoretical model for Comparative Judgment (CJ) that builds upon Thurstone's theory. The model systematically accounts for the factors influencing judges during CJ experiments. These theoretical and practical insights are then translated into a statistical model.
