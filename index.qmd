...
<!-- 1. What has been said about DAGs and SCMs -->
<!-- So far, the explanation of DAGs and SCMs has been fairly concise, sufficient to emphasize their effectiveness in encoding causal structures. However, nothing has been said about the assumptions required to use DAGs and SCMs as encoders of causal assumptions. This is important because, while encoding causal structures with DAGs can be an intriguing exercise in itself, the primary goal of an investigator is to address a research problem. -->
