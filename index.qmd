...
Although a detailed explanation of causes, and counterfactuals is beyond the scope of this document, it suffices to say that causal inference addresses the *fundamental problem of causality* through the use of counterfactuals [@Neal_2020]. The framework defines the *individual causal effect* (ICE) as the difference between an individual's observed and unobserved potential outcomes. These unobserved potential outcomes, termed *counterfactuals*, represent hypothetical scenarios that are *contrary to fact*, where alternative outcomes for an individual, resulting from a specific cause, are neither observed nor observable [@Neal_2020; @Counterfactual_2024]. The framework then extends this estimand to groups by introducing the *average causal effect* (ACE). The ACE reflects the difference between averages of observed potential outcomes and counterfactuals across groups. Finally, similar to an experiment, the framework identifies the ACE from associational estimates by ensuring the absence of confounding.
