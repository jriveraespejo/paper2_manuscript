...
\begin{tikzpicture}
    ...
    % dag_bb3
    \node at (1,0) {$X_{3}$};
    \draw[{Circle}-{latex}](-1,-0.3) to (0,-0.3); % X1 -> X2
    \draw[{Circle}-{latex}{Circle}](0,-0.3) to (1,-0.3); % X2 -> X3
    
    % dag_bb4
    %\node at (0,0.7) {$X_{2}$}; % top
    %\draw[{Circle}-{latex}](-1.5,-0.3) to (0,0.35); % X1 -> X2 (top)
    %\draw[{Circle}-{latex}{Circle}](0,0.4) to (1.5,-0.3); % X2 -> X3 (top)
