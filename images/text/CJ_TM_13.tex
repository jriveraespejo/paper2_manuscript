...
\begin{tikzpicture}
    ...
    \node[gray,gray] at (-0.8,0) {$D_{R}$}; %[gray]
    %\draw[{Circle[open]}-{latex}{Circle},gray](-1,-0.3) to (1.1,-0.3); %,gray
    
    % complete outcome
    \node[gray,gray] at (1.2,0) {$O^{cp}_{R}$}; %[gray]
