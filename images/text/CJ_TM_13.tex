...
\begin{tikzpicture}
    ...
    \node[rectangle,draw,gray] at (1.5,5.4) {$S_{I}$}; %,gray
    \draw[{Circle}-{latex},gray](1.5,5) to (4.45,1.1); %,gray
    ...
    \node[rectangle,draw,gray] at (1.5,3.4) {$S_{A}$}; %,gray
    \draw[{Circle}-{latex},gray](1.5,3) to (4.4,1.05); %,gray
    ...
    \node[rectangle,draw,gray] at (1.5,-1.4) {$S_{K}$}; %,gray
    \draw[{Circle}-{latex},gray](1.5,-1) to (4.4,0.95); %,gray
    ...
    \node[rectangle,draw,gray] at (1.5,-3.4) {$S_{J}$}; %,gray
    \draw[{Circle}-{latex},gray](1.5,-3) to (4.45,0.90); %,gray
    ...
    %\draw[{Circle[open]}-{latex}{Circle},gray](2.9,1) to (4.5,1); %,gray
    \draw[{Circle[open]}-{latex},gray](2.9,1) to (4.4,1); %,gray
