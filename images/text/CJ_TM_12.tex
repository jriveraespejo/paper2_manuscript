...
\begin{tikzpicture}
    ...
    % sub-units' cluster
    \node[gray][font=\scriptsize,gray] at (-6,2.39) {Sub-units}; %,gray
    \draw[dashed,gray] (-6.4,0.39)--(-5.4,0.39)--(-5.4,2.19)--(-6.4,2.19)--(-6.4,0.39); %,gray
    ...
    \node[gray,gray] at (-6,0.93) {$X_{A}$}; %[gray]
    \draw[{Circle}-{latex},gray](-6,0.59) to (-4,1.54); %,gray

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    % units' cluster
    \node[gray][font=\scriptsize,gray] at (-7.5,4.5) {Units}; %,gray
    ...
    % judgments' cluster
    \node[gray][font=\scriptsize,gray] at (-5.9,-0.5) {Judgments}; %,gray
    \draw[dashed,gray] (-6.4,-2.5)--(-5.4,-2.5)--(-5.4,-0.7)--(-6.4,-0.7)--(-6.4,-2.5); %,gray
    ...
    \node[gray,gray] at (-6,-1.2) {$Z_{K}$}; %[gray]
    \draw[{Circle}-{latex},gray](-6,-0.9) to (-4,-1.85); %,gray
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    % judges' cluster
    \node[gray][font=\scriptsize,gray] at (-7.5,-2.5) {Judges}; %,gray
