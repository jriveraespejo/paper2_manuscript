...
# 
# par(mfrow=c(2,2))
# for( alpha in c(1,1.5,5,10) ){
#   delta = rdirichlet( 1000 , alpha=rep(alpha,2) )
#   plot( NULL , xlim=c(1,2) , ylim=c(0,1) , xlab="index" , ylab="probability" )
#   for ( i in 1:nrow(delta) ){ 
#     lines( 1:2 , delta[i,] , type="b", pch=19, lwd=1, col=rgb(0,0,0,0.05) )
#   }  
# }
# par(mfrow=c(1,1))
